...
(
    ...
    err_msg     varchar(200)  null comment '失败原因',
...
(
    ...
    browse_time             int           null comment '视频停留时长（浏览事件有）',
    weixin_video_name       varchar(100)  null comment '视频号-公众号全称',
    weixin_video_name_video int           null comment '视频号-视频序号',
    forward_friend_name     varchar(100)  null comment '转发人名称',
    err_msg                 varchar(200)  null comment '失败原因',
